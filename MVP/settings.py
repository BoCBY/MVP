...
SECRET_KEY = 'django-insecure-%91g*=7vn&25d^s3y0y*^bfgrd%(^+6+r+6w=tpx!m9j!av*11'
...
INSTALLED_APPS = [
    ...
    'apps.exercise_area.apps.ExerciseAreaConfig',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mvp', # 此project要使用的數據庫名稱.
        'USER': 'root', # 使用者帳號.
        'PASSWORD': '84778735', # 使用者密碼.
        'HOST': '127.0.0.1', # 哪台機器按裝mysql.
        'PORT': 3306,
    }
}
